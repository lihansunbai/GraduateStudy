...
MapControl.prototype.setCurrentDrawOperation = function (op) {
    ...
    me.currentDrawOperation.on("drawend", function (e) {
        ...
        me.geometryNumber(op);

        var feature = new ol.format.WKT();
        var coor = {
            type: 'save',
            geo: me.geoString,
...
//  }
    ...
    if (options === 'Point') {
        ...
        me.geoString = 'geopoint';
    } else if (options === 'LineString') {

        me.geoString = 'geoline';
    } else if (options === 'Polygon') {

        me.geoString = 'geopolygon';
    } else {
        me.geoString = 'unknow';
    }
...
MapControl.prototype.getDB = function (options) {
    var me = this;
