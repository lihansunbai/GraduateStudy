    ...
    if (!window.svgEditor) {
        window.svgEditor = function ($) {
            ...
            $.pref = function (key, val) {
                ...
                key = "svg-edit-" + key;
                var host = location.hostname, onweb = host && host.indexOf(".") != -1, store = (val != undefined), storage = false;
                try {
            ...
            Editor.init = function () {
                ...
                $.svgIcons(curConfig.imgPath + "svg_edit_icons.svg", {w: 24, h: 24, id_match: false, no_img: true, fallback_path: curConfig.imgPath, fallback: {new_image: "clear.png", save: "save.png", open: "open.png", source: "source.png", docprops: "document-properties.png", wireframe: "wireframe.png", undo: "undo.png", redo: "redo.png", select: "select.png", select_node: "select_node.png", pencil: "fhpath.png", pen: "line.png", square: "square.png", rect: "rect.png", fh_rect: "freehand-square.png", circle: "circle.png", ellipse: "ellipse.png", fh_ellipse: "freehand-circle.png", path: "path.png", text: "text.png", image: "image.png", zoom: "zoom.png", clone: "clone.png", node_clone: "node_clone.png", "delete": "delete.png", node_delete: "node_delete.png", group: "shape_group.png", ungroup: "shape_ungroup.png", move_top: "move_top.png", move_bottom: "move_bottom.png", to_path: "to_path.png", link_controls: "link_controls.png", reorient: "reorient.png", align_left: "align-left.png", align_center: "align-center", align_right: "align-right", align_top: "align-top", align_middle: "align-middle", align_bottom: "align-bottom", go_up: "go-up.png", go_down: "go-down.png", ok: "save.png", cancel: "cancel.png", arrow_right: "flyouth.png", arrow_down: "dropdown.gif"}, placement: {"#logo": "logo", "#tool_clear div,#layer_new": "new_image", "#tool_save div": "save", "#tool_export div": "export", "#tool_open div div": "open", "#tool_import div div": "import", "#tool_source": "source", "#tool_docprops > div": "docprops", "#tool_wireframe": "wireframe", "#tool_undo": "undo", "#tool_redo": "redo", "#tool_select": "select", "#tool_fhpath": "pencil", "#tool_line": "pen", "#tool_rect,#tools_rect_show": "rect", "#tool_square": "square", "#tool_fhrect": "fh_rect", "#tool_ellipse,#tools_ellipse_show": "ellipse", "#tool_circle": "circle", "#tool_fhellipse": "fh_ellipse", "#tool_path": "path", "#tool_text,#layer_rename": "text", "#tool_image": "image", "#tool_zoom": "zoom", "#tool_clone,#tool_clone_multi": "clone", "#tool_node_clone": "node_clone", "#layer_delete,#tool_delete,#tool_delete_multi": "delete", "#tool_node_delete": "node_delete", "#tool_add_subpath": "add_subpath", "#tool_openclose_path": "open_path", "#tool_move_top": "move_top", "#tool_move_bottom": "move_bottom", "#tool_topath": "to_path", "#tool_node_link": "link_controls", "#tool_reorient": "reorient", "#tool_group": "group", "#tool_ungroup": "ungroup", "#tool_alignleft, #tool_posleft": "align_left", "#tool_aligncenter, #tool_poscenter": "align_center", "#tool_alignright, #tool_posright": "align_right", "#tool_aligntop, #tool_postop": "align_top", "#tool_alignmiddle, #tool_posmiddle": "align_middle", "#tool_alignbottom, #tool_posbottom": "align_bottom", "#cur_position": "align", "#linecap_butt,#cur_linecap": "linecap_butt", "#linecap_round": "linecap_round", "#linecap_square": "linecap_square", "#linejoin_miter,#cur_linejoin": "linejoin_miter", "#linejoin_round": "linejoin_round", "#linejoin_bevel": "linejoin_bevel", "#url_notice": "warning", "#layer_up": "go_up", "#layer_down": "go_down", "#layerlist td.layervis": "eye", "#tool_source_save,#tool_docprops_save": "ok", "#tool_source_cancel,#tool_docprops_cancel": "cancel", "#rwidthLabel, #iwidthLabel": "width", "#rheightLabel, #iheightLabel": "height", "#cornerRadiusLabel span": "c_radius", "#angleLabel": "angle", "#zoomLabel": "zoom", "#tool_fill label": "fill", "#tool_stroke .icon_label": "stroke", "#group_opacityLabel": "opacity", "#blurLabel": "blur", "#font_sizeLabel": "fontsize", ".flyout_arrow_horiz": "arrow_right", ".dropdown button, #main_button .dropdown": "arrow_down", "#palette .palette_item:first, #fill_bg, #stroke_bg": "no_color"}, resize: {"#logo .svg_icon": 32, ".flyout_arrow_horiz .svg_icon": 5, ".layer_button .svg_icon, #layerlist td.layervis .svg_icon": 14, ".dropdown button .svg_icon": 7, "#main_button .dropdown .svg_icon": 9, ".palette_item:first .svg_icon, #fill_bg .svg_icon, #stroke_bg .svg_icon": 16, ".toolbar_button button .svg_icon": 16, ".stroke_tool div div .svg_icon": 20, "#tools_bottom label .svg_icon": 18}, callback: function (icons) {
                        ...
                        $(".tools_flyout").each(function () {
                            ...
                            if (window.opera) {
                                shower.children().removeAttr("style")
                            }
                        });
                        svgEditor.runCallbacks()
                    }});
                Editor.canvas = svgCanvas = new $.SvgCanvas(document.getElementById("svgcanvas"), curConfig);
                var palette = ["#000000", "#3f3f3f", "#7f7f7f", "#bfbfbf", "#ffffff", "#ff0000", "#ff7f00", "#ffff00", "#7fff00", "#00ff00", "#00ff7f", "#00ffff", "#007fff", "#0000ff", "#7f00ff", "#ff00ff", "#ff007f", "#7f0000", "#7f3f00", "#7f7f00", "#3f7f00", "#007f00", "#007f3f", "#007f7f", "#003f7f", "#00007f", "#3f007f", "#7f007f", "#7f003f", "#ffaaaa", "#ffd4aa", "#ffffaa", "#d4ffaa", "#aaffaa", "#aaffd4", "#aaffff", "#aad4ff", "#aaaaff", "#d4aaff", "#ffaaff", "#ffaad4", ];
                isMac = false, modKey = "", path = svgCanvas.pathActions, undoMgr = svgCanvas.undoMgr, Utils = svgCanvas.Utils, default_img_url = curConfig.imgPath + "logo.png", workarea = $("#workarea"), show_save_warning = false, exportWindow = null;
                (function () {
                    ...
                    var dbox = function (type, msg, callback, defText) {
                        ...
                        if (type != "alert") {
                            $('<input type="button" value="' + uiStrings.cancel + '">').appendTo(btn_holder).click(function () {
                                box.hide();
                                callback(false)
                            })
                        }
                ...
                var selectedChanged = function (window, elems) {
                    ...
                    updateContextPanel();
                    svgCanvas.runExtensions("selectedChanged", {elems: elems, selectedElement: selectedElement, multiselected: multiselected})
                };
                var elementChanged = function (window, elems) {
                    for (var i = 0; i < elems.length; ++i) {
                        ...
                        if (elem && elem.tagName == "svg") {
                            ...
                            if (elem && selectedElement && selectedElement.parentNode == null) {
                ...
                var zoomChanged = function (window, bbox, autoCenter) {
                    var scrbar = 15, res = svgCanvas.getResolution(), w_area = workarea, canvas_pos = $("#svgcanvas").position();
                    ...
                    $.each(holders, function (hold_sel, btn_opts) {
                        ...
                        buttons.addClass("tool_button").unbind("click mousedown mouseup").each(function (i) {
                            ...
                            var func = function () {
                                ...
                                shower.append(icon).attr("data-curopt", opts.sel)
                            };
                            $(this).mouseup(func);
                            if (opts.key) {
                ...
                var makeFlyoutHolder = function (id, child) {
                    var div = $("<div>", {"class": "tools_flyout", id: id}).appendTo("#svg_editor").append(child);
                    return div
                };
                ...
                var extAdded = function (window, ext) {
                        ...
                        $.each(ext.context_tools, function (i, tool) {
                            ...
                            switch (tool.type) {
                                case"tool_button":
                                    ...
                                    break;
                                case"select":
                                    var html = "<label" + cont_id + '><select id="' + tool.id + '">';
                                    ...
                                    break;
                                case"button-select":
                                    var html = '<div id="' + tool.id + '" class="dropdown toolset" title="' + tool.title + '"><div id="cur_' + tool.id + '" class="icon_label"></div><button></button></div>';
                                    var list = $('<ul id="' + tool.id + '_opts"></ul>').appendTo("#option_lists");
                                    if (tool.colnum) {
                                        list.addClass("optcols" + tool.colnum)
                                    }
                                    var dropdown = $(html).appendTo(panel).children();
                                    btn_selects.push({elem: ("#" + tool.id), list: ("#" + tool.id + "_opts"), title: tool.title, callback: tool.events.change, cur: ("#cur_" + tool.id)});
                                    break;
                                case"input":
                                    var html = "<label" + cont_id + '><span id="' + tool.id + '_label">' + tool.label + ':</span><input id="' + tool.id + '" title="' + tool.title + '" size="' + (tool.size || "4") + '" value="' + (tool.defval || "") + '" type="text"/></label>';
                    ...
                    if (ext.buttons) {
                                ...
                                if (btn.list) {
                                    ...
                                    if (btn.includeWith) {
                                        ...
                                        if (!ref_btn.parent().hasClass("tools_flyout")) {
                                            ...
                                            var show_btn = ref_btn.clone().attr("id", tls_id + "_show").append($("<div>", {"class": "flyout_arrow_horiz"}));
                                        ...
                                        var cur_h = holders["#" + flyout_holder[0].id] = [{sel: "#" + id, fn: btn.events.click, icon: btn.id, key: btn.key, isDefault: btn.includeWith ? btn.includeWith.isDefault : 0}, ref_data];
                        ...
                        $.svgIcons(svgicons, {w: 24, h: 24, id_match: false, no_img: true, fallback: fallback_obj, placement: placement_obj, callback: function (icons) {
                ...
                var getPaint = function (color, opac) {
                    ...
                    if (color.substr(0, 5) == "url(#") {
                        ...
                        if (color.substr(0, 1) == "#") {
                            opts = {alpha: opac, solidColor: color.substr(1)}
                        } else {
                            opts = {alpha: opac, solidColor: "none"}
                        }
                    }
                ...
                var updateToolbar = function () {
                    if (selectedElement != null && $.inArray(selectedElement.tagName, ["image", "foreignObject", "g", "a"]) === -1) {
                        ...
                        $("#stroke_color rect").attr({fill: strokeColor, opacity: strokeOpacity});
                        $("#fill_color rect").attr({fill: fillColor, opacity: fillOpacity});
                        fillOpacity *= 100;
                        strokeOpacity *= 100;
                    ...
                    if (selectedElement != null) {
                        var opac_perc = ((selectedElement.getAttribute("opacity") || 1) * 100);
                ...
                var updateContextPanel = function () {
                    ...
                    $("#selected_panel, #multiselected_panel, #g_panel, #rect_panel, #circle_panel,					#ellipse_panel, #line_panel, #text_panel, #image_panel").hide();
                    if (elem != null) {
                        ...
                        var panels = {g: [], rect: ["rx", "width", "height"], image: ["width", "height"], circle: ["cx", "cy", "r"], ellipse: ["cx", "cy", "rx", "ry"], line: ["x1", "y1", "x2", "y2"], text: []};
                ...
                var changeZoom = function (ctl) {
                    ...
                    var w_area = workarea;
                    zoomChanged(window, {width: 0, height: 0, x: (w_area[0].scrollLeft + w_area.width() / 2) / zoom, y: (w_area[0].scrollTop + w_area.height() / 2) / zoom, zoom: zoomlevel}, true)
                };
                ...
                $(".palette_item").click(function (evt) {
                    ...
                    if (evt.shiftKey) {
                        ...
                        if (color != "none" && svgCanvas.getStrokeOpacity() != 1) {
                            svgCanvas.setPaintOpacity("stroke", 1)
                        }
                    } else {
                        fillPaint = paint;
                        ...
                        if (color != "none" && svgCanvas.getFillOpacity("fill") != 1) {
                            svgCanvas.setPaintOpacity("fill", 1)
                        }
                    }
                    updateToolButtonState()
                });
                ...
                $("#opac_slider").slider({start: function () {
                ...
                $("#blur_slider").slider({max: 10, step: 0.1, stop: function (evt, ui) {
                        slideStart = false;
                        changeBlur(ui);
                ...
                var clickSave = function () {
                    var saveOpts = {images: curPrefs.img_save, round_digits: 6};
                ...
                var clickGroup = function () {
                    if (multiselected) {
                        ...
                        if (selectedElement && selectedElement.tagName == "g") {
                ...
                var colorPicker = function (elem) {
                    ...
                    $("#color_picker").draggable({cancel: ".jPicker_table,.jGraduate_lgPick,.jGraduate_rgPick"}).css({left: pos.left, bottom: 50 - pos.top}).jGraduate({paint: paint, window: {pickerTitle: title}, images: {clientPath: "jgraduate/images/"}}, function (p) {
                ...
                var updateToolButtonState = function () {
                    ...
                    svgCanvas.runExtensions("toolButtonStateUpdate", {nofill: bNoFill, nostroke: bNoStroke});
                    $(".tools_flyout").each(function () {
                        var shower = $("#" + this.id + "_show");
                ...
                var svgdocbox = new DOMParser().parseFromString('<svg xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%"				fill="#' + curConfig.initFill.color + '" opacity="' + curConfig.initFill.opacity + '"/>				<linearGradient id="gradbox_">						<stop stop-color="#000" offset="0.0"/>						<stop stop-color="#FF0000" offset="1.0"/>				</linearGradient></svg>', "text/xml");
                ...
                $("#stroke_color rect").attr({fill: "#" + curConfig.initStroke.color, opacity: curConfig.initStroke.opacity});
                ...
                $("#layer_new").click(function () {
                    ...
                    for (var i = 0; i < curNames.length; ++i) {
                        curNames[i] = svgCanvas.getLayer(i)
                    }
                ...
                var toggleHighlightLayer = function (layerNameToHighlight) {
                    ...
                    if (layerNameToHighlight) {
                        ...
                        for (var i = 0; i < curNames.length; ++i) {
                            svgCanvas.setLayerOpacity(curNames[i], 1)
                        }
                    }
                };
                ...
                var Actions = function () {
                    ...
                    var key_assocs = {"4/Shift+4": "#tools_rect_show", "5/Shift+5": "#tools_ellipse_show"};
                ...
                Editor.ready(function () {
                    var itool = curConfig.initTool, container = $("#tools_left, #svg_editor .tools_flyout"), pre_tool = container.find("#tool_" + itool), reg_tool = container.find("#" + itool);
                    if (pre_tool.length) {
                        tool = pre_tool
                    } else {
                        if (reg_tool.length) {
                ...
                $("#blur").SpinButton({step: 0.1, min: 0, max: 10, callback: changeBlur});
                ...
                var updateCanvas = Editor.updateCanvas = function (center, new_ctr) {
                    ...
                    var w_area = workarea;
                    var cnvs = $("#svgcanvas");
                    var old_ctr = {x: w_area[0].scrollLeft + w_orig / 2, y: w_area[0].scrollTop + h_orig / 2};
                    ...
                    json_encode = function (obj) {
                        ...
                        if (typeof obj == "boolean" || typeof obj == "number") {
                            ...
                            if (typeof obj == "string") {
                                return'"' + obj.replace(/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, function (a) {
                ...
                Editor.setLang = function (lang, strings) {
                    ...
                    if (strings) {
                        ...
                        setFlyoutTitles();
                        var elems = {"#stroke_color": "#tool_stroke .icon_label, #tool_stroke .color_block", "#fill_color": "#tool_fill label, #tool_fill .color_block", "#linejoin_miter": "#cur_linejoin", "#linecap_butt": "#cur_linecap"};
            ...
            Editor.loadFromURL = function (url) {
                Editor.ready(function () {
                    $.ajax({url: url, dataType: "text", success: svgCanvas.setSvgString, error: function (xhr, stat, err) {
                            if (xhr.responseText) {
